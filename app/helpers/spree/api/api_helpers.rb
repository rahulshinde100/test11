  ...
  module Api
    module ApiHelpers
      ...
      def product_attributes
        [:id, :name, :description, :price, :display_price, :available_on, :permalink, :meta_description, :meta_keywords, :taxon_ids, :product_rate,:is_new_arrival,:is_featured, :is_approved, :is_in_stock, :is_on_sale, :is_warehouse  ]
      end
      ...
      def variant_attributes
        [:id, :name, :sku, :price, :weight, :height, :width, :depth, :is_master, :cost_price, :permalink, :description, :product_id,:stock_on_hand,:special_price]
      end
      ...
      def order_attributes
        [:id, :number, :item_total, :total, :state, :adjustment_total, :user_id, :created_at, :updated_at, :completed_at, :payment_total, :shipment_state,:order_state, :payment_state, :email, :special_instructions,:delivery_date, :user_name, :shipping_category, :pickup_during, :oms_shipment_state]
      end

      def line_item_attributes
        [:id, :quantity, :price, :variant_id, :is_pick_at_store,:picked_up, :stock_location_id, :ready_for_pickup]
      end
      ...
      def taxonomy_attributes
        [:id, :name, :created_at, :updated_at, :position,:permalink]
      end
      ...
      def user_attributes
        [:id, :email, :created_at, :updated_at,:firstname,:lastname,]
      end
      ...
      def stock_location_attributes
        [:id, :name, :address1, :address2, :city, :state_id, :state_name, :country_id, :zipcode, :phone, :active, :lat,:lng]
      end
      ...
      def stock_item_attributes
        [:id, :count_on_hand, :backorderable, :lock_version, :stock_location_id, :variant_id, :stock_location_name]
      end
      ...
      def seller_attributes
        [:id,:name,:description,:banner,:logo, :permalink]
      end
      ...
      def brands_attributes
        [:name, :description, :logo, :banner, :permalink]
      end
    end
  end
end